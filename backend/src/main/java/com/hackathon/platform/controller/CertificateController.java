...
public class CertificateController{
    ...
    public CertificateController(CertificateService certificateService, TeamMemberRepository teamMemRepo) {
    ...
    public ResponseEntity<CertificateVerificationResponse> verify(@PathVariable String verificationCode){
