...
public class AiModelClient {
  ...
  public Optional<AiPredictionResponse> predict(
      TelemetryFeatureService.TelemetryFeatures features) {
    AiPredictionRequest req =
    ...
    try {
      AiPredictionResponse res =
          rest.post().uri("/predict").body(req).retrieve().body(AiPredictionResponse.class);
