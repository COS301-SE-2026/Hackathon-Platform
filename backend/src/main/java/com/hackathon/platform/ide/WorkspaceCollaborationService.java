...
public class WorkspaceCollaborationService {
    ...
    public WorkspaceEditBroadcast applyEdit(UUID workspaceId, WorkspaceEditMessage message, User user) {
        ...
        synchronized (version) {
            ...
            if (message.baseVersion() != currV) {
                throw new IllegalStateException("Stale file version, Expected" + currV + " but got: " +message.baseVersion());
            }
