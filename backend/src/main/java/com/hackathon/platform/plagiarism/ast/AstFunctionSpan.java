...
/**
 * A function/method discovered while parsing a source file, with its byte offsets into the original
 * (not normalized) source. Consumed by the embedding stage to slice out real source text per
 * function for CodeBERT
 */
