...
class LeaderboardServiceTest {
  ...
  private static LeaderboardEntry entry(
      UUID teamId, String teamName, String score, Instant lastScoredAt) {
  ...
  private static class TestLeaderboardEntry implements LeaderboardEntry {
    ...
    private TestLeaderboardEntry(
        UUID teamId, String teamName, BigDecimal bestScore, Instant lastScoredAt) {
      this.teamId = teamId;
